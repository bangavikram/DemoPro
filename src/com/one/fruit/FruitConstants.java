...
public class FruitConstants {
	...
	public static final float BANANA_PRICE = 5f;
	public static final float APPLE_PRICE = 10f;
	public static final float ORANGE_PRICE = 6f;
	public static final float PEACH_PRICE = 12f;
	public static final float LEMON_PRICE = 8f;
}
